[API Reference](/doc/api/index.md) &raquo; [Yannoff](../index.md) &raquo; [Component](../index.md) &raquo; [Console](../index.md) &raquo; [Exception](./index.md) &raquo; [FatalException][self]
...
_Represent a blocking exception: when raised code execution should terminate_</br>

Source file: [src/Exception/FatalException.php](/src/Exception/FatalException.php)
### Properties
