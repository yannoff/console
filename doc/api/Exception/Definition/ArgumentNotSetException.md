...
*Thrown by ArgvResolver when trying to get the value of an argument that was not supplied by the user and has no default value*</br>
...
*ArgumentNotSetException constructor.*</br>
