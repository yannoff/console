[API Reference](/doc/api/index.md) &raquo; [Yannoff](../../index.md) &raquo; [Component](../../index.md) &raquo; [Console](../../index.md) &raquo; [Exception](../index.md) &raquo; [Definition](./index.md) &raquo; [ArgumentNotSetException][self]
...
_Thrown by ArgvResolver when trying to get the value of an argument that was not supplied by the user and has no default value_</br>

Source file: [src/Exception/Definition/ArgumentNotSetException.php](/src/Exception/Definition/ArgumentNotSetException.php)
### Properties

- [$code](#argumentnotsetexceptioncode)
- [$file](#argumentnotsetexceptionfile)
- [$line](#argumentnotsetexceptionline)
- [$message](#argumentnotsetexceptionmessage)

### Methods

- [__construct()](#argumentnotsetexception__construct)
- [__toString()](#argumentnotsetexception__toString)
...
```php
ArgumentNotSetException::__construct($name, $code, $previous)
```

_ArgumentNotSetException constructor._</br>
...
----|----|-----------
$name|[string][php:string]|Name of the queried argument
...
```php
ArgumentNotSetException::__toString()
```
