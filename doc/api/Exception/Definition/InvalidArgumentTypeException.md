[API Reference](/doc/api/index.md) &raquo; [Yannoff](../../index.md) &raquo; [Component](../../index.md) &raquo; [Console](../../index.md) &raquo; [Exception](../index.md) &raquo; [Definition](./index.md) &raquo; [InvalidArgumentTypeException][self]
...
_Thrown by Argument constructor when an invalid value was supplied for the type property_</br>

Source file: [src/Exception/Definition/InvalidArgumentTypeException.php](/src/Exception/Definition/InvalidArgumentTypeException.php)
### Properties

- [$code](#invalidargumenttypeexceptioncode)
- [$file](#invalidargumenttypeexceptionfile)
- [$line](#invalidargumenttypeexceptionline)
- [$message](#invalidargumenttypeexceptionmessage)

### Methods

- [__construct()](#invalidargumenttypeexception__construct)
- [__toString()](#invalidargumenttypeexception__toString)
...
```php
InvalidArgumentTypeException::__construct($name, $value, $code, $previous)
```

_InvalidArgumentTypeException constructor._</br>
...
----|----|-----------
$name|[string][php:string]|Name of the argument with invalid type
$value|[mixed][php:mixed]|Value of the invalid argument type
...
```php
InvalidArgumentTypeException::__toString()
```
