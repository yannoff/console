[API Reference](/doc/api/index.md) &raquo; [Yannoff](../index.md) &raquo; [Component](../index.md) &raquo; [Console](../index.md) &raquo; [Exception](./index.md) &raquo; [LogicException][self]
...
_Base class for exceptions raised by a misconception in the command or application code_</br>

Source file: [src/Exception/LogicException.php](/src/Exception/LogicException.php)
### Properties

- [$code](#logicexceptioncode)
- [$file](#logicexceptionfile)
- [$line](#logicexceptionline)
- [$message](#logicexceptionmessage)

### Methods

- [__construct()](#logicexception__construct)
- [__toString()](#logicexception__toString)
