[API Reference](/doc/api/index.md) &raquo; [Yannoff](../../index.md) &raquo; [Component](../../index.md) &raquo; [Console](../../index.md) &raquo; [Exception](../index.md) &raquo; [IO](./index.md) &raquo; [UnsupportedStreamException][self]
...
<br/>
_**extends** [StreamLogicException](/doc/api/Exception/IO/StreamLogicException.md)_
<br/>
...
_Thrown by StreamFactory when queried an unsupported stream short name_</br>

Source file: [src/Exception/IO/UnsupportedStreamException.php](/src/Exception/IO/UnsupportedStreamException.php)
### Properties

- [$code](#unsupportedstreamexceptioncode)
- [$file](#unsupportedstreamexceptionfile)
- [$line](#unsupportedstreamexceptionline)
- [$message](#unsupportedstreamexceptionmessage)

### Methods

- [__construct()](#unsupportedstreamexception__construct)
- [__toString()](#unsupportedstreamexception__toString)
...
```php
UnsupportedStreamException::__construct($stream, $code, $previous)
```

_UnsupportedStreamException constructor._</br>
...
----|----|-----------
$stream|[string][php:string]|Queried stream short name
...
```php
UnsupportedStreamException::__toString()
```
