[API Reference](/doc/api/index.md) &raquo; [Yannoff](../../index.md) &raquo; [Component](../../index.md) &raquo; [Console](../../index.md) &raquo; [Exception](../index.md) &raquo; [IO](./index.md) &raquo; [TagMismatchException][self]


# Class TagMismatchException

**FQN:** [Yannoff\Component\Console\Exception\IO\TagMismatchException][self]
<br/>
...
_Thrown by PosixFormatter::format() when trying to_</br>
_close a tag that was not previously opened_</br>
_Eg: "This is my text</strong> with a mismatch"_</br>

Source file: [src/Exception/IO/TagMismatchException.php](/src/Exception/IO/TagMismatchException.php)
### Properties

- [$code](#tagmismatchexceptioncode)
- [$file](#tagmismatchexceptionfile)
- [$line](#tagmismatchexceptionline)
- [$message](#tagmismatchexceptionmessage)

### Methods

- [__construct()](#tagmismatchexception__construct)
- [__toString()](#tagmismatchexception__toString)
...
### <a name="code">`TagMismatchException::$code`</a>
...
### <a name="file">`TagMismatchException::$file`</a>
...
### <a name="line">`TagMismatchException::$line`</a>
...
### <a name="message">`TagMismatchException::$message`</a>
...
### <a name="__construct">`TagMismatchException::__construct()`</a>

```php
TagMismatchException::__construct($message, $code, $previous)
```
...
### <a name="__toString">`TagMismatchException::__toString()`</a>

```php
TagMismatchException::__toString()
```
