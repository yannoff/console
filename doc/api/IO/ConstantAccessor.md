...
**FQN:** [Yannoff\Component\Console\IO\ConstantAccessor][self]
<br/>
...
### <a name="get">`ConstantAccessor::get()`</a>
...
Type|Description
----|-----------
[UndefinedConstantException](/doc/api/Exception/UndefinedConstantException.md)|If the queried class constant is not defined

<br/><br/>


[self]: ConstantAccessor.md
